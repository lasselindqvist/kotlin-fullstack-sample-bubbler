(function (_, Kotlin, $module$react_dom, $module$kotlinx_html_js, $module$react) {
  ...
  async$lambda$ObjectLiteral.$metadata$ = {kind: Kotlin.Kind.CLASS, interfaces: [Continuation]};
  ...
  function main$lambda$lambda(this$) {
    return function ($receiver) {
      ...
      var props = createInstance(Kotlin.getKClass(ReactComponentNoProps));
      $this.enterReactNode_uztyw4$(ReactComponent.Companion.wrap_v5not5$(Kotlin.getKClass(Application)), props, ReactBuilder$invoke$lambda(props, main$lambda$lambda$lambda));
      return Unit;
    };
  }
  ...
  Application$Companion.$metadata$ = {kind: Kotlin.Kind.OBJECT, simpleName: 'Companion', interfaces: [ReactComponentSpec]};
  ...
  function Application$render$lambda$lambda$lambda$lambda_0(this$Application, this$render) {
    return function ($receiver) {
      if (this$Application.state.selected !== MainView$Loading_getInstance()) {
        ...
        var props = createInstance(Kotlin.getKClass(NavBarComponent$NavBarHandlerProps));
        $this.enterReactNode_uztyw4$(ReactComponent.Companion.wrap_v5not5$(Kotlin.getKClass(NavBarComponent)), props, ReactBuilder$invoke$lambda(props, handler));
      }
      return Unit;
    };
  }
  ...
  function Application$render$lambda$lambda_0(this$Application, this$render) {
    return function ($receiver) {
      ...
      if (Kotlin.equals(tmp$, MainView$Loading_getInstance()))
        h1($receiver, void 0, Application$render$lambda$lambda$lambda_0);
      else if (Kotlin.equals(tmp$, MainView$Home_getInstance())) {
        var $this = this$render;
        HomeView$Companion_getInstance();
        var handler = Application$render$lambda$lambda$lambda_1(this$Application);
        var props = createInstance(Kotlin.getKClass(HomeView$Props));
        $this.enterReactNode_uztyw4$(ReactComponent.Companion.wrap_v5not5$(Kotlin.getKClass(HomeView)), props, ReactBuilder$invoke$lambda(props, handler));
      }
       else if (Kotlin.equals(tmp$, MainView$Login_getInstance())) {
        ...
        var props_0 = createInstance(Kotlin.getKClass(UserProps));
        $this_0.enterReactNode_uztyw4$(ReactComponent.Companion.wrap_v5not5$(Kotlin.getKClass(LoginComponent)), props_0, ReactBuilder$invoke$lambda(props_0, handler_0));
      }
       else if (Kotlin.equals(tmp$, MainView$Register_getInstance())) {
        ...
        var props_1 = createInstance(Kotlin.getKClass(UserProps));
        $this_1.enterReactNode_uztyw4$(ReactComponent.Companion.wrap_v5not5$(Kotlin.getKClass(RegisterComponent)), props_1, ReactBuilder$invoke$lambda(props_1, handler_1));
      }
       else if (Kotlin.equals(tmp$, MainView$JoinBubble_getInstance())) {
        var $this_2 = this$render;
        JoinBubbleComponent$Companion_getInstance();
        var props_2 = createInstance(Kotlin.getKClass(UserProps));
        $this_2.enterReactNode_uztyw4$(ReactComponent.Companion.wrap_v5not5$(Kotlin.getKClass(JoinBubbleComponent)), props_2, ReactBuilder$invoke$lambda(props_2, Application$render$lambda$lambda$lambda_4));
      }
       else if (Kotlin.equals(tmp$, MainView$LeaveBubble_getInstance())) {
        var $this_3 = this$render;
        LeaveBubbleComponent$Companion_getInstance();
        var props_3 = createInstance(Kotlin.getKClass(UserProps));
        $this_3.enterReactNode_uztyw4$(ReactComponent.Companion.wrap_v5not5$(Kotlin.getKClass(LeaveBubbleComponent)), props_3, ReactBuilder$invoke$lambda(props_3, Application$render$lambda$lambda$lambda_5));
      }
       else if (Kotlin.equals(tmp$, MainView$ShowBubble_getInstance())) {
        ...
        var props_4 = createInstance(Kotlin.getKClass(ShowBubbleComponent$Props));
        $this_4.enterReactNode_uztyw4$(ReactComponent.Companion.wrap_v5not5$(Kotlin.getKClass(ShowBubbleComponent)), props_4, ReactBuilder$invoke$lambda(props_4, handler_2));
      }
       else if (Kotlin.equals(tmp$, MainView$ViewBubble_getInstance())) {
        var $this_5 = this$render;
        ViewBubbleComponent$Companion_getInstance();
        var props_5 = createInstance(Kotlin.getKClass(ViewBubbleComponent$Props));
        $this_5.enterReactNode_uztyw4$(ReactComponent.Companion.wrap_v5not5$(Kotlin.getKClass(ViewBubbleComponent)), props_5, ReactBuilder$invoke$lambda(props_5, Application$render$lambda$lambda$lambda_7));
      }
       else if (Kotlin.equals(tmp$, MainView$PostThought_getInstance())) {
        ...
        var props_6 = createInstance(Kotlin.getKClass(NewThoughtComponent$Props));
        $this_6.enterReactNode_uztyw4$(ReactComponent.Companion.wrap_v5not5$(Kotlin.getKClass(NewThoughtComponent)), props_6, ReactBuilder$invoke$lambda(props_6, handler_3));
      }
       else if (!Kotlin.equals(tmp$, MainView$User_getInstance()))
        if (Kotlin.equals(tmp$, MainView$Thought_getInstance())) {
          ...
          var props_7 = createInstance(Kotlin.getKClass(ViewThoughtComponent$Props));
          $this_7.enterReactNode_uztyw4$(ReactComponent.Companion.wrap_v5not5$(Kotlin.getKClass(ViewThoughtComponent)), props_7, ReactBuilder$invoke$lambda(props_7, handler_4));
        }
         else
  ...
  function Application$onLoggedOut$lambda(closure$oldSelected) {
    return function ($receiver) {
      ...
      if (Kotlin.equals(tmp$, MainView$Home_getInstance()) || Kotlin.equals(tmp$, MainView$Thought_getInstance()) || Kotlin.equals(tmp$, MainView$Login_getInstance()) || Kotlin.equals(tmp$, MainView$Register_getInstance()))
  ...
  Coroutine$Application$checkUserSession$lambda.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
    ...
    do
      try {
        switch (this.state_0) {
          ...
          case 2:
            this.local$user = this.result_0;
            return this.local$this$Application.onUserAssigned_0(this.local$user), Unit;
        }
      }
       catch (e) {
        if (this.state_0 === 1)
  ...
  Application.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'Application', interfaces: [ReactDOMComponent]};
  ...
  MainView.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'MainView', interfaces: [Enum]};
  ...
  function MainView$valueOf(name) {
    switch (name) {
      ...
      default:Kotlin.throwISE('No enum constant org.jetbrains.demo.bubbler.MainView.' + name);
    }
  }
  ...
  ApplicationPageState.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'ApplicationPageState', interfaces: []};
  function UserProps() {
    RProps.call(this);
  ...
  UserProps.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'UserProps', interfaces: [RProps]};
  ...
  HomeView$Companion.$metadata$ = {kind: Kotlin.Kind.OBJECT, simpleName: 'Companion', interfaces: [ReactComponentSpec]};
  ...
  function HomeView$render$lambda(this$HomeView, this$render) {
    return function ($receiver) {
      ...
      if (this$HomeView.state.loading) {
        ...
        var props = createInstance(Kotlin.getKClass(ThoughtsListComponent$Props));
        $this.enterReactNode_uztyw4$(ReactComponent.Companion.wrap_v5not5$(Kotlin.getKClass(ThoughtsListComponent)), props, ReactBuilder$invoke$lambda_1(props, handler));
        h3($receiver, void 0, HomeView$render$lambda$lambda_3);
        var $this_0 = this$render;
        ThoughtsListComponent$Companion_getInstance();
        var handler_0 = HomeView$render$lambda$lambda_4(this$HomeView);
        var props_0 = createInstance(Kotlin.getKClass(ThoughtsListComponent$Props));
        $this_0.enterReactNode_uztyw4$(ReactComponent.Companion.wrap_v5not5$(Kotlin.getKClass(ThoughtsListComponent)), props_0, ReactBuilder$invoke$lambda_1(props_0, handler_0));
      }
      return Unit;
    };
  }
  ...
  Coroutine$HomeView$loadHome$lambda.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
      ...
      try {
        switch (this.state_0) {
          ...
          case 2:
            ...
            return this.local$this$HomeView.setState_hgm6vj$(HomeView$loadHome$lambda$lambda(this.local$r)), Unit;
        }
      }
       catch (e) {
        if (this.state_0 === 1)
  ...
  HomeView$State.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'State', interfaces: []};
  ...
  HomeView$Props.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'Props', interfaces: [RProps]};
  ...
  function HomeView$pollerHandler$lambda(this$HomeView) {
    return function (m) {
      ...
      if (!Kotlin.equals(oldMessages, m) && Kotlin.equals(m, Polling$NewMessages$None_getInstance())) {
        this$HomeView.loadHome_0();
      }
      return Unit;
    };
  }
  HomeView.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'HomeView', interfaces: [ReactDOMComponent]};
  ...
  JoinBubbleComponent$Companion.$metadata$ = {kind: Kotlin.Kind.OBJECT, simpleName: 'Companion', interfaces: [ReactComponentSpec]};
  ...
  Coroutine$JoinBubbleComponent$doJoin$lambda.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
  ...
  JoinBubbleComponent.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'JoinBubbleComponent', interfaces: [ReactDOMComponent]};
  ...
  JoinBubbleFormState.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'JoinBubbleFormState', interfaces: []};
  ...
  LeaveBubbleComponent$Companion.$metadata$ = {kind: Kotlin.Kind.OBJECT, simpleName: 'Companion', interfaces: [ReactComponentSpec]};
  ...
  Coroutine$LeaveBubbleComponent$doJoin$lambda.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
  ...
  LeaveBubbleComponent.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'LeaveBubbleComponent', interfaces: [ReactDOMComponent]};
  ...
  LeaveBubbleFormState.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'LeaveBubbleFormState', interfaces: []};
  ...
  LoginComponent$Companion.$metadata$ = {kind: Kotlin.Kind.OBJECT, simpleName: 'Companion', interfaces: [ReactComponentSpec]};
  ...
  Coroutine$LoginComponent$doLogin$lambda.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
    ...
    do
      try {
        switch (this.state_0) {
          ...
          case 2:
            this.local$user = this.result_0;
            return this.local$this$LoginComponent.loggedIn_0(this.local$user), Unit;
        }
      }
       catch (e) {
        if (this.state_0 === 1)
  ...
  LoginComponent.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'LoginComponent', interfaces: [ReactDOMComponent]};
  ...
  LoginFormState.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'LoginFormState', interfaces: []};
  ...
  NavBarComponent$Companion.$metadata$ = {kind: Kotlin.Kind.OBJECT, simpleName: 'Companion', interfaces: [ReactComponentSpec]};
  ...
  function NavBarComponent$render$lambda(closure$newMessages, this$NavBarComponent, closure$user) {
    return function ($receiver) {
      ...
      if (Kotlin.equals(tmp$, Polling$NewMessages$None_getInstance()))
        tmp$_0 = '';
  ...
  Coroutine$NavBarComponent$logout$lambda.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
  ...
  NavBarComponent$NavBarState.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'NavBarState', interfaces: []};
  ...
  NavBarComponent$NavBarHandlerProps.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'NavBarHandlerProps', interfaces: [RProps]};
  ...
  NavBarComponent.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'NavBarComponent', interfaces: [ReactDOMComponent]};
  ...
  NewThoughtComponent$Companion.$metadata$ = {kind: Kotlin.Kind.OBJECT, simpleName: 'Companion', interfaces: [ReactComponentSpec]};
  ...
  function Coroutine$NewThoughtComponent$doPostThought$lambda(this$NewThoughtComponent_0, continuation_0) {
    ...
    this.local$thought = void 0;
  }
  Coroutine$NewThoughtComponent$doPostThought$lambda.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
      ...
      try {
        switch (this.state_0) {
          ...
          case 2:
            ...
            this.state_0 = 3;
            this.result_0 = postThought((this.local$tmp$ = this.local$this$NewThoughtComponent.props.replyTo) != null ? this.local$tmp$.id : null, this.local$this$NewThoughtComponent.state.text, this.local$this$NewThoughtComponent.state.bubbleName, this.local$token, this);
            if (this.result_0 === intrinsics.COROUTINE_SUSPENDED)
              return intrinsics.COROUTINE_SUSPENDED;
            break;
          case 3:
            this.local$thought = this.result_0;
            return this.local$this$NewThoughtComponent.onSubmitted_0(this.local$thought), Unit;
        }
      }
       catch (e) {
        if (this.state_0 === 1)
  ...
  function NewThoughtComponent$onFailed$lambda(closure$err) {
    return function ($receiver) {
      $receiver.errorMessage = closure$err.message + Kotlin.toString(closure$err.cause);
      return Unit;
    };
  }
  ...
  NewThoughtComponent$State.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'State', interfaces: []};
  ...
  NewThoughtComponent$Props.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'Props', interfaces: [RProps]};
  NewThoughtComponent.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'NewThoughtComponent', interfaces: [ReactDOMComponent]};
  ...
  function Coroutine$Polling$tick$lambda(this$Polling_0, continuation_0) {
    ...
    this.local$tmp$ = void 0;
    this.local$newMessagesText = void 0;
    this.local$newMessages = void 0;
    this.local$tmp$_0 = void 0;
    this.local$element = void 0;
  }
  Coroutine$Polling$tick$lambda.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
      ...
      try {
        switch (this.state_0) {
          ...
          case 1:
            throw this.exception_0;
          case 2:
            this.local$newMessagesText = this.result_0;
            if (Kotlin.equals(this.local$newMessagesText, '0') || isBlank(this.local$newMessagesText))
              this.local$tmp$ = Polling$NewMessages$None_getInstance();
            else if (endsWith(this.local$newMessagesText, '+'))
              this.local$tmp$ = new Polling$NewMessages$MoreThan(toInt(removeSuffix(this.local$newMessagesText, '+')));
            else
              this.local$tmp$ = new Polling$NewMessages$Few(toInt(this.local$newMessagesText));
            this.local$newMessages = this.local$tmp$;
            this.local$tmp$_0 = this.local$this$Polling.listeners.iterator();
            while (this.local$tmp$_0.hasNext()) {
              this.local$element = this.local$tmp$_0.next();
              this.local$element(this.local$newMessages);
            }
  ...
  Polling$NewMessages$None.$metadata$ = {kind: Kotlin.Kind.OBJECT, simpleName: 'None', interfaces: [Polling$NewMessages]};
  ...
  Polling$NewMessages$Few.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'Few', interfaces: [Polling$NewMessages]};
  ...
  Polling$NewMessages$MoreThan.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'MoreThan', interfaces: [Polling$NewMessages]};
  ...
  Polling$NewMessages.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'NewMessages', interfaces: []};
  Polling.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'Polling', interfaces: []};
  var ReactMarkdown;
  ...
  ReactMarkdownProps.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'ReactMarkdownProps', interfaces: [RProps]};
  function ReactMarkdownComponent() {
    ReactMarkdownComponent_instance = this;
    ReactExternalComponentSpec.call(this, ReactMarkdown);
  }
  ReactMarkdownComponent.$metadata$ = {kind: Kotlin.Kind.OBJECT, simpleName: 'ReactMarkdownComponent', interfaces: [ReactExternalComponentSpec]};
  ...
  RegisterComponent$Companion.$metadata$ = {kind: Kotlin.Kind.OBJECT, simpleName: 'Companion', interfaces: [ReactComponentSpec]};
  ...
  Coroutine$RegisterComponent$doRegister$lambda.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
  ...
  Coroutine$RegisterComponent$doRegister$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.local$receiver = this.local$this$RegisterComponent.state;
            this.local$closure$continuation = this;
            this.local$this$RegisterComponent_0 = this.local$this$RegisterComponent;
            this.state_0 = 2;
            this.result_0 = register(this.local$receiver.login, this.local$receiver.password, this.local$receiver.displayName, this.local$receiver.email, this.local$receiver.phoneNumber, this.local$closure$continuation);
            if (this.result_0 === intrinsics.COROUTINE_SUSPENDED)
              return intrinsics.COROUTINE_SUSPENDED;
            break;
          case 1:
            throw this.exception_0;
          case 2:
            this.local$user = this.local$closure$continuation.result_0;
            this.local$this$RegisterComponent_0.registered_0(this.local$user);
            return Unit;
        }
      }
       catch (e) {
  ...
  RegisterComponent.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'RegisterComponent', interfaces: [ReactDOMComponent]};
  ...
  RegisterFormState.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'RegisterFormState', interfaces: []};
  function index(continuation) {
    return getAndParseResult('/', null, Kotlin.getCallableRef('parseIndexResponse', function (json) {
  ...
  function register(userId, password, displayName, email, phoneNumber, continuation) {
    ...
    return postAndParseResult('/register', $receiver, Kotlin.getCallableRef('parseLoginOrRegisterResponse', function (json) {
  ...
  function checkSession(continuation) {
    return getAndParseResult('/login', null, Kotlin.getCallableRef('parseLoginOrRegisterResponse', function (json) {
      return parseLoginOrRegisterResponse(json);
    }), continuation);
  }
  function login(userId, password, continuation) {
    ...
    $receiver.append('userId', userId);
    $receiver.append('password', password);
    return postAndParseResult('/login', $receiver, Kotlin.getCallableRef('parseLoginOrRegisterResponse', function (json) {
      return parseLoginOrRegisterResponse(json);
    }), continuation);
  }
  function joinBubble(userId, bubbleName, continuation) {
    ...
    return postAndParseResult('/join-bubble', $receiver, Kotlin.getCallableRef('parseJoinBubbleResponse', function (json) {
  ...
  function showBubble(userId, bubbleName, continuation) {
    ...
    $receiver.append('userId', userId);
    $receiver.append('bubbleName', bubbleName);
    return postAndParseResult('/show-bubble', $receiver, Kotlin.getCallableRef('parseShowBubbleResponse', function (json) {
  ...
  function viewBubble(userId, bubbleName, continuation) {
    ...
    $receiver.append('userId', userId);
    $receiver.append('bubbleName', bubbleName);
    return postAndParseResult('/view-bubble', $receiver, Kotlin.getCallableRef('parseViewBubbleResponse', function (json) {
  ...
  function leaveBubble(userId, bubbleName, continuation) {
    ...
    $receiver.append('userId', userId);
    $receiver.append('bubbleName', bubbleName);
    return postAndParseResult('/leave-bubble', $receiver, Kotlin.getCallableRef('parseLeaveBubbleResponse', function (json) {
      return parseLeaveBubbleResponse(json);
    }), continuation);
  }
  function postThoughtPrepare(continuation) {
    return getAndParseResult('/post-new', null, Kotlin.getCallableRef('parseNewPostTokenResponse', function (json) {
  ...
  function postThought(replyTo, text, bubbleName, token, continuation) {
    ...
    return postAndParseResult('/post-new', $receiver, Kotlin.getCallableRef('parsePostThoughtResponse', function (json) {
  ...
  Object.defineProperty(logoutUser$ObjectLiteral.prototype, 'method', {get: function () {
    return this.method_7loug4$_0;
  }, set: function (method) {
    this.method_7loug4$_0 = method;
  }});
  Object.defineProperty(logoutUser$ObjectLiteral.prototype, 'credentials', {get: function () {
    return this.credentials_el3cjf$_0;
  }, set: function (credentials) {
    this.credentials_el3cjf$_0 = credentials;
  }});
  logoutUser$ObjectLiteral.$metadata$ = {kind: Kotlin.Kind.CLASS, interfaces: []};
  ...
  Coroutine$logoutUser.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
  ...
  function parseIndexResponse(json) {
    var tmp$, tmp$_0;
    var top = Kotlin.isArray(tmp$ = json.top) ? tmp$ : Kotlin.throwCCE();
    var latest = Kotlin.isArray(tmp$_0 = json.latest) ? tmp$_0 : Kotlin.throwCCE();
  ...
  Object.defineProperty(LoginOrRegisterFailedException.prototype, 'message', {get: function () {
    return this.message_4vo8d$_0;
  }});
  Object.defineProperty(LoginOrRegisterFailedException.prototype, 'cause', {get: function () {
    return this.cause_dam0c5$_0;
  }});
  LoginOrRegisterFailedException.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'LoginOrRegisterFailedException', interfaces: [Throwable]};
  ...
  Object.defineProperty(JoiningBubbleFailedException.prototype, 'message', {get: function () {
    return this.message_jhylr2$_0;
  }});
  Object.defineProperty(JoiningBubbleFailedException.prototype, 'cause', {get: function () {
    return this.cause_g1ssg0$_0;
  }});
  JoiningBubbleFailedException.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'JoiningBubbleFailedException', interfaces: [Throwable]};
  ...
  Object.defineProperty(ShowingBubbleFailedException.prototype, 'message', {get: function () {
    return this.message_eehh5d$_0;
  }});
  Object.defineProperty(ShowingBubbleFailedException.prototype, 'cause', {get: function () {
    return this.cause_wd9sy5$_0;
  }});
  ShowingBubbleFailedException.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'ShowingBubbleFailedException', interfaces: [Throwable]};
  ...
  Object.defineProperty(ViewingBubbleFailedException.prototype, 'message', {get: function () {
    return this.message_wz22x3$_0;
  }});
  Object.defineProperty(ViewingBubbleFailedException.prototype, 'cause', {get: function () {
    return this.cause_14zufv$_0;
  }});
  ViewingBubbleFailedException.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'ViewingBubbleFailedException', interfaces: [Throwable]};
  ...
  Object.defineProperty(LeavingBubbleFailedException.prototype, 'message', {get: function () {
    return this.message_2fr7oe$_0;
  }});
  Object.defineProperty(LeavingBubbleFailedException.prototype, 'cause', {get: function () {
    return this.cause_ykuzes$_0;
  }});
  LeavingBubbleFailedException.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'LeavingBubbleFailedException', interfaces: [Throwable]};
  ...
  Object.defineProperty(requestAndParseResult$ObjectLiteral.prototype, 'method', {get: function () {
    return this.method_eqn0kr$_0;
  }, set: function (method) {
    this.method_eqn0kr$_0 = method;
  }});
  Object.defineProperty(requestAndParseResult$ObjectLiteral.prototype, 'body', {get: function () {
    return this.body_qr8w3a$_0;
  }, set: function (body) {
    this.body_qr8w3a$_0 = body;
  }});
  Object.defineProperty(requestAndParseResult$ObjectLiteral.prototype, 'credentials', {get: function () {
    return this.credentials_z6j1zg$_0;
  }, set: function (credentials) {
    this.credentials_z6j1zg$_0 = credentials;
  }});
  Object.defineProperty(requestAndParseResult$ObjectLiteral.prototype, 'headers', {get: function () {
    return this.headers_jn0upu$_0;
  }, set: function (headers) {
    this.headers_jn0upu$_0 = headers;
  }});
  requestAndParseResult$ObjectLiteral.$metadata$ = {kind: Kotlin.Kind.CLASS, interfaces: []};
  ...
  Coroutine$requestAndParseResult.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
  ...
  ShowBubbleComponent$Companion.$metadata$ = {kind: Kotlin.Kind.OBJECT, simpleName: 'Companion', interfaces: [ReactComponentSpec]};
  ...
  function ShowBubbleComponent$render$thoughtLi$lambda$lambda$lambda_0(closure$t, this$render) {
    return function ($receiver) {
      ...
      var props = createInstance(Kotlin.getKClass(ReactMarkdownProps));
  ...
  function ShowBubbleComponent$render$lambda$lambda$lambda_3(closure$top, closure$thoughtLi) {
    return function ($receiver) {
      ...
      if (!closure$top.isEmpty()) {
        tmp$ = toMutableList(closure$top).iterator();
        while (tmp$.hasNext()) {
          var t = tmp$.next();
  ...
  function ShowBubbleComponent$render$lambda$lambda$lambda_4(closure$latest, closure$thoughtLi) {
    return function ($receiver) {
      ...
      if (!closure$latest.isEmpty()) {
        tmp$ = toMutableList(closure$latest).iterator();
        while (tmp$.hasNext()) {
          var t = tmp$.next();
          closure$thoughtLi($receiver, t);
        }
  ...
  function ShowBubbleComponent$render$lambda(this$render, this$ShowBubbleComponent, closure$thoughtLi) {
    return function ($receiver) {
      ...
      if (this$ShowBubbleComponent.state.showBubbleResponse != null && !this$ShowBubbleComponent.state.loading) {
        var latest = this$ShowBubbleComponent.state.latest;
        var top = this$ShowBubbleComponent.state.top;
  ...
  function Coroutine$ShowBubbleComponent$doShow$lambda(this$ShowBubbleComponent_0, continuation_0) {
    ...
    this.local$localResponse = void 0;
  }
  Coroutine$ShowBubbleComponent$doShow$lambda.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
      ...
      try {
        switch (this.state_0) {
          ...
          case 1:
            throw this.exception_0;
          case 2:
            this.local$localResponse = this.result_0;
            if (this.local$localResponse != null) {
              this.local$this$ShowBubbleComponent.state.showBubbleResponse = this.local$localResponse;
              this.local$this$ShowBubbleComponent.state.latest = this.local$localResponse.latest;
              this.local$this$ShowBubbleComponent.state.top = this.local$localResponse.top;
  ...
  ShowBubbleComponent.prototype.doShow_0 = function () {
    ...
    console.log(Kotlin.toString(this.state.showBubbleResponse));
  ...
  ShowBubbleComponent$Props.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'Props', interfaces: [RProps]};
  ...
  ShowBubbleComponent$State.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'State', interfaces: []};
  ShowBubbleComponent.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'ShowBubbleComponent', interfaces: [ReactDOMComponent]};
  ...
  ThoughtsListComponent$Companion.$metadata$ = {kind: Kotlin.Kind.OBJECT, simpleName: 'Companion', interfaces: [ReactComponentSpec]};
  ...
  ThoughtsListComponent$Props.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'Props', interfaces: [RProps]};
  ThoughtsListComponent.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'ThoughtsListComponent', interfaces: [ReactDOMComponent]};
  ...
  ViewBubbleComponent$Companion.$metadata$ = {kind: Kotlin.Kind.OBJECT, simpleName: 'Companion', interfaces: [ReactComponentSpec]};
  ...
  function ViewBubbleComponent$render$lambda$lambda(this$render, this$ViewBubbleComponent) {
    return function ($receiver) {
      ...
      if (this$ViewBubbleComponent.state.viewBubbleResponse != null) {
        ...
        var props = createInstance(Kotlin.getKClass(ThoughtsListComponent$Props));
        $this.enterReactNode_uztyw4$(ReactComponent.Companion.wrap_v5not5$(Kotlin.getKClass(ThoughtsListComponent)), props, ReactBuilder$invoke$lambda_4(props, handler));
        ...
        var props_0 = createInstance(Kotlin.getKClass(ThoughtsListComponent$Props));
        $this_0.enterReactNode_uztyw4$(ReactComponent.Companion.wrap_v5not5$(Kotlin.getKClass(ThoughtsListComponent)), props_0, ReactBuilder$invoke$lambda_4(props_0, handler_0));
      }
  ...
  function Coroutine$ViewBubbleComponent$doView$lambda(this$ViewBubbleComponent_0, continuation_0) {
    ...
    this.local$tmp$ = void 0;
    this.local$viewBubbleResponse = void 0;
  }
  Coroutine$ViewBubbleComponent$doView$lambda.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
      ...
      try {
        switch (this.state_0) {
          ...
          case 2:
            ...
            this.local$viewBubbleResponse = this.local$this$ViewBubbleComponent.state.viewBubbleResponse;
            if (this.local$viewBubbleResponse != null) {
              this.local$this$ViewBubbleComponent.state.latest = this.local$viewBubbleResponse.latest;
              return this.local$this$ViewBubbleComponent.state.top = this.local$viewBubbleResponse.top, Unit;
            }
             else {
              this.state_0 = 3;
              continue;
  ...
  ViewBubbleComponent$Props.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'Props', interfaces: [RProps]};
  ViewBubbleComponent.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'ViewBubbleComponent', interfaces: [ReactDOMComponent]};
  ...
  ViewBubbleFormState.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'ViewBubbleFormState', interfaces: []};
  ...
  ViewThoughtComponent$Companion.$metadata$ = {kind: Kotlin.Kind.OBJECT, simpleName: 'Companion', interfaces: [ReactComponentSpec]};
  ...
  Coroutine$ViewThoughtComponent$delete$lambda.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
      ...
      try {
        switch (this.state_0) {
          ...
          case 2:
            this.local$token = this.result_0;
            this.state_0 = 3;
            this.result_0 = deleteThought(this.local$this$ViewThoughtComponent.props.thought.id, this.local$token.date, this.local$token.code, this);
            if (this.result_0 === intrinsics.COROUTINE_SUSPENDED)
              return intrinsics.COROUTINE_SUSPENDED;
            break;
          case 3:
  ...
  ViewThoughtComponent$Props.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'Props', interfaces: [RProps]};
  ViewThoughtComponent.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'ViewThoughtComponent', interfaces: [ReactDOMComponent]};
  ...
  Thought.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'Thought', interfaces: []};
  ...
  User.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'User', interfaces: []};
  ...
  Bubble.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'Bubble', interfaces: []};
  ...
  RpcData.$metadata$ = {kind: Kotlin.Kind.INTERFACE, simpleName: 'RpcData', interfaces: []};
  function IndexResponse(top, latest) {
    this.top = top;
    this.latest = latest;
  }
  IndexResponse.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'IndexResponse', interfaces: [RpcData]};
  ...
  PostThoughtToken.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'PostThoughtToken', interfaces: [RpcData]};
  ...
  ViewBubbleResponse.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'ViewBubbleResponse', interfaces: [RpcData]};
  ...
  ShowBubbleResponse.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'ShowBubbleResponse', interfaces: [RpcData]};
  ...
  ReactComponentNoState.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'ReactComponentNoState', interfaces: []};
  function ReactComponentNoProps() {
    RProps.call(this);
  }
  ReactComponentNoProps.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'ReactComponentNoProps', interfaces: [RProps]};
  ...
  Object.defineProperty(ReactBuilder$Node.prototype, 'realType', {get: function () {
    return this.type;
  }});
  ...
  ReactBuilder$Node.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'Node', interfaces: []};
  Object.defineProperty(ReactBuilder.prototype, 'children', {get: function () {
    return this.currentNode().children;
  }});
  ReactBuilder.prototype.currentNode = function () {
    return last(this.path);
  };
  ReactBuilder.prototype.currentNodeOfType_rku8s3$ = defineInlineFunction('frontend.react.ReactBuilder.currentNodeOfType_rku8s3$', function (T_0, isT) {
    var tmp$;
  ...
  ReactBuilder.prototype.instantiateProps_xu0bud$ = defineInlineFunction('frontend.react.ReactBuilder.instantiateProps_xu0bud$', wrapFunction(function () {
  ...
  ReactBuilder.prototype.invoke_6pvil0$ = defineInlineFunction('frontend.react.ReactBuilder.invoke_6pvil0$', wrapFunction(function () {
    var Unit = Kotlin.kotlin.Unit;
    ...
    return function (T_0, isT, P_0, isP, $receiver, handler) {
      ...
      return this.enterReactNode_uztyw4$(ReactComponent.Companion.wrap_v5not5$(Kotlin.getKClass(T_0)), props, ReactBuilder$invoke$lambda_0(props, handler));
    };
  }));
  ReactBuilder.prototype.invoke_yo4to9$ = defineInlineFunction('frontend.react.ReactBuilder.invoke_yo4to9$', wrapFunction(function () {
    var Unit = Kotlin.kotlin.Unit;
    function ReactBuilder$invoke$lambda($receiver) {
      return Unit;
    }
  ...
  ReactBuilder.prototype.node_g12n31$ = defineInlineFunction('frontend.react.ReactBuilder.node_g12n31$', wrapFunction(function () {
    var Unit = Kotlin.kotlin.Unit;
    var ReactComponent = _.react.ReactComponent;
    ...
    return function (T_0, isT, P_0, isP, $receiver, props, handler) {
      ...
      return this.enterReactNode_uztyw4$(ReactComponent.Companion.wrap_v5not5$(Kotlin.getKClass(T_0)), props, handler);
    };
  }));
  ReactBuilder.prototype.invoke_hz9fqm$ = defineInlineFunction('frontend.react.ReactBuilder.invoke_hz9fqm$', wrapFunction(function () {
    var Unit = Kotlin.kotlin.Unit;
    function ReactBuilder$invoke$lambda($receiver) {
      return Unit;
    }
  ...
  ReactBuilder.prototype.node_arc5mv$ = defineInlineFunction('frontend.react.ReactBuilder.node_arc5mv$', wrapFunction(function () {
    var Unit = Kotlin.kotlin.Unit;
    function ReactBuilder$node$lambda($receiver) {
      return Unit;
    }
  ...
  ReactBuilder.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'ReactBuilder', interfaces: []};
  function RProps() {
    this.key = null;
    this.children = null;
  }
  RProps.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'RProps', interfaces: []};
  function ReactComponentSpec() {
  }
  ReactComponentSpec.$metadata$ = {kind: Kotlin.Kind.INTERFACE, simpleName: 'ReactComponentSpec', interfaces: []};
  var initWrapper;
  function ReactComponent() {
    ...
    this.stateField_8be2vx$ = this.stateField_8be2vx$;
    this.isSealed_8be2vx$ = false;
    this.hasState_8be2vx$ = false;
  }
  Object.defineProperty(ReactComponent.prototype, 'props', {get: function () {
    return this.wrapper_8be2vx$.props;
  }});
  Object.defineProperty(ReactComponent.prototype, 'state', {get: function () {
  ...
  ReactComponent$Companion.prototype.wrap_x51phs$ = defineInlineFunction('frontend.react.ReactComponent.Companion.wrap_x51phs$', function (K_0, isK) {
    return this.wrap_v5not5$(Kotlin.getKClass(K_0));
  });
  ...
  ReactComponent$Companion.$metadata$ = {kind: Kotlin.Kind.OBJECT, simpleName: 'Companion', interfaces: []};
  ...
  ReactComponent.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'ReactComponent', interfaces: [ReactExtensionProvider]};
  ...
  Object.defineProperty(ReactComponentWrapper.prototype, 'state', {get: function () {
  ...
  ReactComponentWrapper.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'ReactComponentWrapper', interfaces: []};
  function ReactExtensionProvider() {
  }
  ReactExtensionProvider.$metadata$ = {kind: Kotlin.Kind.INTERFACE, simpleName: 'ReactExtensionProvider', interfaces: []};
  function ReactExternalComponentSpec(ref) {
    this.ref = ref;
  }
  ReactExternalComponentSpec.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'ReactExternalComponentSpec', interfaces: []};
  ...
  ReactWrapper.$metadata$ = {kind: Kotlin.Kind.OBJECT, simpleName: 'ReactWrapper', interfaces: []};
  ...
  DOMProps.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'DOMProps', interfaces: [RProps]};
  ...
  ReactDOMBuilder$DOMNode.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'DOMNode', interfaces: [ReactBuilder$Node]};
  ...
  ReactDOMBuilder$onTagContentUnsafe$ObjectLiteral.$metadata$ = {kind: Kotlin.Kind.CLASS, interfaces: [Unsafe]};
  ...
  ReactDOMBuilder.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'ReactDOMBuilder', interfaces: [TagConsumer, ReactBuilder]};
  ...
  Object.defineProperty(ReactDOMComponent.prototype, 'DOMNode', {get: function () {
  ...
  ReactDOMComponent.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: 'ReactDOMComponent', interfaces: [ReactComponent]};
  ...
  Object.defineProperty(Application, 'Companion', {get: Application$Companion_getInstance});
  package$bubbler.Application = Application;
  Object.defineProperty(MainView, 'Loading', {get: MainView$Loading_getInstance});
  Object.defineProperty(MainView, 'Register', {get: MainView$Register_getInstance});
  Object.defineProperty(MainView, 'Login', {get: MainView$Login_getInstance});
  Object.defineProperty(MainView, 'User', {get: MainView$User_getInstance});
  Object.defineProperty(MainView, 'JoinBubble', {get: MainView$JoinBubble_getInstance});
  Object.defineProperty(MainView, 'LeaveBubble', {get: MainView$LeaveBubble_getInstance});
  Object.defineProperty(MainView, 'ShowBubble', {get: MainView$ShowBubble_getInstance});
  Object.defineProperty(MainView, 'ViewBubble', {get: MainView$ViewBubble_getInstance});
  Object.defineProperty(MainView, 'PostThought', {get: MainView$PostThought_getInstance});
  Object.defineProperty(MainView, 'Thought', {get: MainView$Thought_getInstance});
  Object.defineProperty(MainView, 'Home', {get: MainView$Home_getInstance});
  ...
  Object.defineProperty(HomeView, 'Companion', {get: HomeView$Companion_getInstance});
  HomeView.State = HomeView$State;
  HomeView.Props = HomeView$Props;
  package$bubbler.HomeView = HomeView;
  Object.defineProperty(JoinBubbleComponent, 'Companion', {get: JoinBubbleComponent$Companion_getInstance});
  package$bubbler.JoinBubbleComponent = JoinBubbleComponent;
  package$bubbler.JoinBubbleFormState = JoinBubbleFormState;
  Object.defineProperty(LeaveBubbleComponent, 'Companion', {get: LeaveBubbleComponent$Companion_getInstance});
  package$bubbler.LeaveBubbleComponent = LeaveBubbleComponent;
  package$bubbler.LeaveBubbleFormState = LeaveBubbleFormState;
  Object.defineProperty(LoginComponent, 'Companion', {get: LoginComponent$Companion_getInstance});
  package$bubbler.LoginComponent = LoginComponent;
  package$bubbler.LoginFormState = LoginFormState;
  Object.defineProperty(NavBarComponent, 'Companion', {get: NavBarComponent$Companion_getInstance});
  ...
  Object.defineProperty(NewThoughtComponent, 'Companion', {get: NewThoughtComponent$Companion_getInstance});
  ...
  Object.defineProperty(Polling$NewMessages, 'None', {get: Polling$NewMessages$None_getInstance});
  ...
  Object.defineProperty(package$bubbler, 'ReactMarkdownComponent', {get: ReactMarkdownComponent_getInstance});
  Object.defineProperty(RegisterComponent, 'Companion', {get: RegisterComponent$Companion_getInstance});
  ...
  Object.defineProperty(ShowBubbleComponent, 'Companion', {get: ShowBubbleComponent$Companion_getInstance});
  ...
  Object.defineProperty(ThoughtsListComponent, 'Companion', {get: ThoughtsListComponent$Companion_getInstance});
  ThoughtsListComponent.Props = ThoughtsListComponent$Props;
  package$bubbler.ThoughtsListComponent = ThoughtsListComponent;
  Object.defineProperty(ViewBubbleComponent, 'Companion', {get: ViewBubbleComponent$Companion_getInstance});
  ...
  Object.defineProperty(ViewThoughtComponent, 'Companion', {get: ViewThoughtComponent$Companion_getInstance});
  ...
  Object.defineProperty(ReactComponent, 'Companion', {get: ReactComponent$Companion_getInstance});
  ...
  Object.defineProperty(package$react, 'ReactWrapper', {get: ReactWrapper_getInstance});
