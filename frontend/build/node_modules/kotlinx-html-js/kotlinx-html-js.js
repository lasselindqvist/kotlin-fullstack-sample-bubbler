(function (root, factory) {
  ...
  function col($receiver, classes, block) {
    ...
    if (block === void 0)
      block = col$lambda;
    var tmp$;
    return Kotlin.isType(tmp$ = visitAndFinalize(new COL(attributesMapOf_0('class', classes), $receiver), $receiver, block), HTMLTableColElement) ? tmp$ : Kotlin.throwCCE();
  }
  ...
  function colGroup($receiver, classes, block) {
    ...
    var tmp$;
    return Kotlin.isType(tmp$ = visitAndFinalize(new COLGROUP(attributesMapOf_0('class', classes), $receiver), $receiver, block), HTMLTableColElement) ? tmp$ : Kotlin.throwCCE();
  }
  ...
  function head($receiver, content) {
    if (content === void 0)
      content = '';
    var tmp$;
    return Kotlin.isType(tmp$ = visitAndFinalize(new HEAD(emptyMap_0, $receiver), $receiver, head$lambda(content)), HTMLHeadElement) ? tmp$ : Kotlin.throwCCE();
  }
  ...
  function html($receiver, content) {
    if (content === void 0)
      content = '';
    var tmp$;
    return Kotlin.isType(tmp$ = visitAndFinalize(new HTML(emptyMap_0, $receiver), $receiver, html$lambda(content)), HTMLHtmlElement) ? tmp$ : Kotlin.throwCCE();
  }
  ...
  function meta($receiver, name, content, charset, block) {
    ...
    if (block === void 0)
      block = meta$lambda;
    var tmp$;
    return Kotlin.isType(tmp$ = visitAndFinalize(new META(attributesMapOf_1(['name', name, 'content', content, 'charset', charset]), $receiver), $receiver, block), HTMLMetaElement) ? tmp$ : Kotlin.throwCCE();
  }
  ...
  function script($receiver, type, src, content) {
    ...
    if (content === void 0)
      content = '';
    var tmp$;
    return Kotlin.isType(tmp$ = visitAndFinalize(new SCRIPT(attributesMapOf_1(['type', type, 'src', src]), $receiver), $receiver, script$lambda(content)), HTMLScriptElement) ? tmp$ : Kotlin.throwCCE();
  }
  ...
  function th($receiver, scope, classes, block) {
    ...
    if (block === void 0)
      block = th$lambda;
    var tmp$;
    return Kotlin.isType(tmp$ = visitAndFinalize(new TH(attributesMapOf_1(['scope', scope != null ? enumEncode(scope) : null, 'class', classes]), $receiver), $receiver, block), HTMLTableCellElement) ? tmp$ : Kotlin.throwCCE();
  }
