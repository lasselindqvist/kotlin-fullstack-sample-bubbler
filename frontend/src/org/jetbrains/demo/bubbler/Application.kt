        ...
        div("pure-g") {
            ...
            div("content pure-u-1 pure-u-md-3-4") {
                when (state.selected) {
                    ...
                    MainView.JoinBubble -> JoinBubbleComponent {
                    }
                    MainView.LeaveBubble -> LeaveBubbleComponent {
                    }
                    MainView.ShowBubble -> ShowBubbleComponent {
                        showThought = { t -> onShowThought(t) }
                    }
                    MainView.ViewBubble -> ViewBubbleComponent {
                    }
            ...
            div("footer") {
                +"Bubbler kotlin frontend + react + ktor example"
            }
        }
    }
...
class ApplicationPageState(var selected: MainView, var currentUser: User? = null, var bubbleName: String = "", var currentThought: Thought? = null, var replyTo: Thought? = null) : RState
