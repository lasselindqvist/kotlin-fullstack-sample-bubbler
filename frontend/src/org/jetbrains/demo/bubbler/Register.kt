...
class RegisterComponent : ReactDOMComponent<UserProps, RegisterFormState>() {
        ...
        div {
            form(classes = "pure-form pure-form-stacked") {
                ...
                fieldSet(classes = "pure-group") {
                    ...
                    input(type = InputType.text, name = "phoneNumber") {
    ...
    private fun doRegister() {
        ...
        async {
            with(state) {
                val user = register(login, password, displayName, email, phoneNumber)
                registered(user)
            }
...
class RegisterFormState(var login: String, var displayName: String, var password: String, var email: String, var phoneNumber: String, var errorMessage: String?, var disabled: Boolean) : RState
