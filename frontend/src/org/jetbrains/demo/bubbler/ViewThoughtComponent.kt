...
class ViewThoughtComponent : ReactDOMComponent<ViewThoughtComponent.Props, ReactComponentNoState>() {
    ...
    override fun ReactDOMBuilder.render() {
        ...
        val replyTo = props.thought.replyTo
        val bubbleId = props.thought.bubbleId
        ...
        div(classes = "pure-g") {
            ...
            div(classes = "pure-u-1 pure-u-md-1-3") {
                +userId
                bubbleId?.let { id ->
                    + " sent this message in bubble $id"
                }
            }
    ...
    class Props(var thought: Thought, var currentUser: User? = null, var bubbleName: String? = "", var reply: (Thought) -> Unit = {}, var leave: () -> Unit = {}) : RProps()
}